...
<body>
    <form name="tip_write_form" method="POST" action="notify_write_proce.php">
        <!-- method : POST!!! (GET X) -->
            ...
            <tr>
                <td bgcolor=white>
                    ...
                    <center>
                        ...
                        <button type="button" style="height:26px; width:47px; font-size:16px;" onclick="location.href='notify_list_manage.php'"> 취소</button>
                    </center>
                </td>
            </tr>
        </table>
